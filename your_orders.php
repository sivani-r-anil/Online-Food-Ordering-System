...
<th>Remarks</th>
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
										  ...
										  {
$order_id = $row['o_id'];
        $remark_query = mysqli_query($db, "SELECT * FROM remark WHERE frm_id = '$order_id'");
        $remark_row = mysqli_fetch_array($remark_query);
        $remark = $remark_row ? $remark_row['remark'] : '';
 ...
 <td data-column="Remark">
                ...
                <!-- Display the remark from the database -->
                <?php
 if (!empty($remark)) 
{ ?>
                    <p><?php echo htmlspecialchars($remark); ?></p>
                <?php } else { ?>
