...
<input name="mod" id="radio" checked value="paypal" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span><span class="custom-control-description">Google Pay<img src="images/gpay.jpeg" alt="" width="90">
</span></label></li>
                                        </ul>
